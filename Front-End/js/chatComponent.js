                ...
                if (msgInput.value != '') {
                    ...
                    fetch('http://localhost:8080/conversations')
                        ...
                        .then(conversations.forEach(conversation => {
                                ...
                                sendingBtnWrapper.appendChild(submitBtn); inputWrapper.appendChild(msgInput); chatFooter.appendChild(inputWrapper); chatFooter.appendChild(sendingBtnWrapper); chatViewWrapper.appendChild(chatHeader); chatViewWrapper.appendChild(chatBody); chatViewWrapper.appendChild(chatFooter);
